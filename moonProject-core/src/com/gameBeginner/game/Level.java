...
import com.gameBeginner.object.Clouds;
import com.gameBeginner.object.Feather;
import com.gameBeginner.object.GoldCoin;
import com.gameBeginner.object.Mountains;
import com.gameBeginner.object.Rock;
import com.gameBeginner.object.WaterOverlay;
...
public class Level extends AbstractGameObject{
	...
	private void init(String filename) {
		...
		for (int pixelY = 0; pixelY < pixmap.getHeight(); pixelY++) {
			...
			Gdx.app.debug(TAG, "finish searching");
			// decoration
			clouds = new Clouds(pixmap.getWidth());
			clouds.position.set(0, 2);
			mountains = new Mountains(pixmap.getWidth());
			mountains.position.set(-1, -1);
			waterOverlay = new WaterOverlay((float)pixmap.getWidth());
	...
	/* (non-Javadoc)
	 * @see com.gameBeginner.object.AbstractGameObject#render(com.badlogic.gdx.graphics.g2d.SpriteBatch)
	 */
	@Override
